...
class Article extends \yii\db\ActiveRecord
{
    ...
    public function yearDate()
    {
       $year_date = date_create($this->date);
            return date_format($year_date, 'Y');      
    }
    
    public function dayDate()
    {
       $day_date = date_create($this->date);
            return date_format($day_date, 'd');      
    }
    
    public function monthDate()
    {
       $month_date = date_create($this->date);
            return date_format($month_date, 'F');      
    }
